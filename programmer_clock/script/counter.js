(function() {
  ...
  $(function() {
    return (function() {
      var Words, alignDigit, counter, now;
      alignDigit = function(num) {
        if (num < 10) {
          return "0" + num;
        } else {
          return num;
      ...
      counter = function(background, clock, word) {
        var current;
        current = now();
        background.attr({
        ...
        return setTimeout(function() {
          return counter(background, clock, word);
        }, 1000);
      };
      return counter($('#bg'), $('#clock'), $('#word'));
    })();
  });
